                            ...
                            <tbody>
                                <?php foreach ($list_buy as $item): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <input data-id="<?php echo $item['id']?>" type="number" name="qty[<?php echo $item['id']; ?>]" min="1" max="10 "
                                    ...
                                    <td colspan="7">
                                        <div class="clearfix">
                                            <div class="fl-right">
                                                ...
                                                <a href="?mod=cart&action=checkout" id="checkout-cart">Thanh toán</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
...
<script scr="public/js/jquery-2.2.4.min.js"></script>
